        ...
        <div class="mt-10">
            <div class="grid grid-cols-12 justify-stretch">
                <div class="col-span-10">
                    <input type="text" class = "border-2 border-slate-200 hover:border-slate-300 focus:hover:border-slate-300 py-2 pl-4 w-full rounded-xl" placeholder="Enter your url" name = "original_url" value = "<?php if(check_session()) { echo $_SESSION["shorten_url"]; } ?>" required>
                </div>

                <div class="col-span-2 text-center">
                    <button id="copy-btn" class="bg-blue-500 p-2 rounded-xl text-slate-100 px-4" type="submit">Copy</button>
                </div>
            </div>
            <p class="inline-block mr-2 my-2"> Long URL :</p><span class="text-blue-500"><?php if(check_session()) { echo $_SESSION["original_url"]; } ?></span> 

            <div class="my-8">
                <div class="my-3"><a href="../index.php" class="border-2 border-blue-500 bg-blue-500 text-slate-50 rounded-md p-1">Total of clicks of your shortened URL</a></div>
                <div class="my-3"><a href="../index.php" class="border-2 border-blue-500 bg-blue-500 text-slate-50 rounded-md p-1">Shorten another URL</a></div>
            </div>
        </div>
